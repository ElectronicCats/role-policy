...
class IrModelAccess(models.Model):
    ...
    def _get_acl_access_group_ids(self, model, crud):
        ...
        :param crud: any combination of the letters crud
        ...
        """
        # Permission field names come from _CRUD dict which is internally
        # controlled, so string formatting is safe here
        for access in crud:
